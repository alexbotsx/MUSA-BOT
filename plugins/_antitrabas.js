/**
𝗠𝗨𝗦𝗔-𝗕𝗢𝗧@BrunoSobrino - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '51944026510-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝗠𝗨𝗦𝗔-𝗕𝗢𝗧', 'jpegThumbnail': null } } };
